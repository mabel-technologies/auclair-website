...
<div class="wp-block-group">
	...
	<!-- wp:paragraph {"style":{"typography":{"fontSize":"16px"},"color":{"text":"var(--wp--preset--color--foreground-primary)"}}} -->
	<p style="max-width:455px;font-size:16px;color:var(--wp--preset--color--foreground-primary)"><?php esc_html_e( "Can't find the answer? Tell us what's going on and our team will get back to you within 24 hours.", 'auclair' ); ?></p>
	<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
