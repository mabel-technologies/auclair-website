...
/**
 * Title: Article Page
 * Slug: auclair-help-center/article-page
 * Description: The full Help Center article page composition.
 * Categories: auclair
 *
...
<!-- wp:auclair/article-header /-->

<!-- wp:auclair/article-body /-->

<!-- wp:auclair/article-feedback /-->

<!-- wp:auclair/related-queries /-->
