...
class Assets implements ModuleInterface {
	...
	public function enqueue_frontend_assets() {
		wp_enqueue_style(
			'auclair-help-center-styles',
			AU_CLAIR_HELP_CENTER_THEME_TEMPLATE_URL . '/dist/css/frontend.css',
			[],
			$this->get_asset_info( 'frontend', 'version' )
		);

		wp_enqueue_script(
			'auclair-help-center-frontend',
			AU_CLAIR_HELP_CENTER_THEME_TEMPLATE_URL . '/dist/js/frontend.js',
	...
	public function enqueue_block_editor_assets() {
		wp_enqueue_style(
			'auclair-help-center-editor-frame-style-overrides',
			AU_CLAIR_HELP_CENTER_THEME_TEMPLATE_URL . '/dist/css/editor-frame-style-overrides.css',
			[],
			AU_CLAIR_HELP_CENTER_THEME_VERSION
		);

		wp_enqueue_script(
			'auclair-help-center-block-extensions',
			AU_CLAIR_HELP_CENTER_THEME_TEMPLATE_URL . '/dist/js/block-extensions.js',
	...
	public function enqueue_block_editor_iframe_assets() {
		...
		wp_enqueue_style(
			'auclair-help-center-editor-canvas-style-overrides',
			AU_CLAIR_HELP_CENTER_THEME_TEMPLATE_URL . '/dist/css/editor-canvas-style-overrides.css',
			[],
			AU_CLAIR_HELP_CENTER_THEME_VERSION
		);
	}
	...
	public function register_all_icons() {
		...
		$icon_paths = glob( AU_CLAIR_HELP_CENTER_THEME_DIST_PATH . 'svg/*.svg' );
