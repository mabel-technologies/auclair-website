...
/***/ "./blocks/category-card/block.json":
/*!*****************************************!*\
  !*** ./blocks/category-card/block.json ***!
  \*****************************************/
/***/ (function(module) {
...
!function() {
/*!****************************************!*\
  !*** ./blocks/category-card/index.tsx ***!
  \****************************************/
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./block.json */ "./blocks/category-card/block.json");
var _jsxFileName = "/Users/stephingasper/Documents/repos/auclair-website/wp-content/themes/auclair-help-center/blocks/category-card/index.tsx";
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_6__.name, {
  edit: ({
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Term ID', 'auclair'),
      type: "number",
      value: termId ? String(termId) : '',
      onChange: value => setAttributes({
        termId: Number(value) || 0
      }),
      __self: undefined,
      __source: {
        fileName: _jsxFileName,
      ...
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Ring animation on hover', 'auclair'),
      checked: !!animate,
    ...
    }), termId ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_4___default()), {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)('Choose a help_category term ID in the sidebar.', 'auclair'))));
  },
  save: () => null
});
}();
