...
1. **auclair-help-center**: A traditional WordPress theme with modern development practices
2. **auclair-help-center**: A block-based theme utilizing WordPress Full Site Editing (FSE) features
...
### Traditional Theme (auclair-help-center)

The traditional theme (`auclair-help-center`) combines classic WordPress theme structure with modern development practices:
...
### Block Theme (auclair-help-center)

The block theme (`auclair-help-center`) is built for WordPress Full Site Editing:
...
- `au_clair_help_center_theme_loaded`: Fired after theme is loaded
- `au_clair_help_center_theme_init`: Fired after theme initialization
- `au_clair_help_center_theme_before_init`: Fired before theme initialization
- `au_clair_help_center_theme_init_priority`: Filter to modify initialization priority
