...
If you want to jump right in, take a look at the `AuclairCore\PostTypes\Demo` and `AuclairCore\Taxonomies\Demo` classes.
...
If you find yourself making the same changes across multiple classes or projects, please consider [opening a ticket](https://github.com/au-clair-help-center/au-clair-help-center/issues/new?assignees=&labels=type%3Aenhancement&projects=&template=2-enhancement.yml) which describes those changes.
