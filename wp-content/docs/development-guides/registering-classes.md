...
```php
$site_settings = \AuclairCore\PluginCore::get_module( '\AuclairCore\Admin\SiteSettings' );
$a_theme_class = \AuclairHelpCenter\ThemeCore::get_module( '\AuclairHelpCenter\Some\Theme\Class' );
```
