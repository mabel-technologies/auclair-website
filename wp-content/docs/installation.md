...
After your project is scaffolded and underway, you may need to add additional plugins. The `scaffold:plugin` command downloads the reference auclair-core from GitHub and integrates it into your existing project.
...
2. Downloads the reference plugin from the au-clair-help-center/au-clair-help-center GitHub repository
